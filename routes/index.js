...
var proyectosCtrl = require('../controllers/ProyectosCtrl');
var colaboradoresCtrl = require('../controllers/ColaboradoresCtrl');
...
router.route('/proyectos/:id')
  .get(proyectosCtrl.getProyectoById) //Devuelve el proyecto con el ID indicado.
...
router.route('/colaboradores/:id')
  .get(colaboradoresCtrl.getColaboradorById) //Devuelve los datos del colaborador y todos los proyectos en los que participa.
